...
const { Boards, Modlogs } = require(__dirname+'/../../db/')
	...
	, settingChangeEntries = Object.entries({
		...
		'cleanExif': ['deletehtml', 'css', 'scripts'],
...
module.exports = async (req, res) => {
	...
	const newSettings = {
		...
		cleanExif: booleanSetting(req.body.clean_exif, oldSettings.cleanExif),
		rejectFailedExifClean: booleanSetting(req.body.reject_failed_exif_clean, oldSettings.rejectFailedExifClean),
